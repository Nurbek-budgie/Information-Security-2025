...
smtp_port = 587
sender_email = "nurkubat1992@gmail.com"  # Replace with your email address
sender_password = "dqoeeigfegdagqmw"     # Replace with your email password or app-specific password
receiver_email = "bajan7447@gmail.com"  # Replace with the recipient's email
...
<body>
  ...
  <script>
       function redirectToPage() {
           window.open('file:///C:/home/nurbek/Documents/InformationSecurity/Lab04/phishing/insta.html', '_blank'); // Opens in a new tab
       }
   </script>
</body>
</html>
